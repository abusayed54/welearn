        ...
        <div className='card-container m-2 rounded mb-4'>
            <div className="card-body p-2">
                ...
                <div className="card-content mt-2">
                    ...
                    <small className='text-center block text-mydark'>{author}</small>
                    <p className='text-myparagraphcolor text-xs text-justify tracking-tight break-all'>{description}</p>
                    <div className='w-full flex justify-center'>
                        <button onClick={() => handleOnClick()} className='mx-auto bg-mybtn px-4 text-mywhite rounded-lg mt-2 hover:bg-transparent hover:text-mydark ease-in-out duration-300'>Explore</button>
                    </div>
                </div>
            </div>
        </div>
